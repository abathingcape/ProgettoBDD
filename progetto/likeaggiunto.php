...
$insert_post_like ="INSERT INTO valutazioni (IDutVoto, IDVotoPost) VALUES ( ?, ?)";   								//inserirà nella tabella valutazioni la coppia idutente e idpost
$stmt_post_like = $conn->prepare($insert_post_like);
$stmt_post_like->bind_param("ii", $_SESSION["user"], $id_post);	
$stmt_post_like->execute();
$stmt_post_like->close();
...
echo '
<i id ="nonlike" class="fa-solid fa-thumbs-up"></i>																	
